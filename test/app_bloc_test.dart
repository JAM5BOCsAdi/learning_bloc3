...
import 'package:learning_bloc3/bloc/app_bloc.dart';
import 'package:learning_bloc3/bloc/app_state.dart';
import 'package:learning_bloc3/bloc/bloc_events.dart';
...
void main() {
  ...
  blocTest<AppBloc, AppState>(
    'Test throwing an error from urlLoader and catch it',
    build: () => AppBloc(
      urls: [],
      urlPicker: (_) => '',
